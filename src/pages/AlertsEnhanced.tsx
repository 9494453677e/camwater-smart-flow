...
const AlertsEnhanced = () => {
  ...
  const handleViewDetails = (alert: any) => {
    toast({
      ...
      description: `Zone: ${alert.zone} | Severity: ${alert.severity} | Status: ${alert.status}`,
    });
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handleAlertSettings} className="bg-blue-600 hover:bg-blue-700">
            ...
            {alerts.map((alert) => (
              <div 
                ...
                className={`p-4 border rounded-lg transition-all hover:shadow-md ${
                  alert.acknowledged ? 'bg-white' : 'bg-blue-50 border-blue-200'
                }`}
              >
